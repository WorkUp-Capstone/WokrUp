...
public class User {
  ...
  @Column private boolean chosen = false;
  ...
  public User(
      long id, String email, String password, String first_name, String last_name, Role role) {
    this.id = id;
    this.email = email;
    this.password = password;
    this.first_name = first_name;
  ...
  public boolean isPasswordsEqual() {
    return passwordsEqual && password.equals(passwordRepeat);
  }
