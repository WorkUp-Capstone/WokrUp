...
public class ProjectController {
    ...
    /**
     * Lines below commented in the event we need to show one project outside of the card view in
     * the projects' index (dev/home) *note that show.html does not exist
     */
